...
title: "Everyone Says AGI Is Coming in 5 Years. They're Probably Wrong."
date: 2025-11-13
description:
  "AI leaders keep predicting AGI by 2028. Let me show you why you should take
  those predictions with a massive grain of salt."
tags: ["blog", "AI", "AGI", "Predictions", "Reality Check"]
---
...
1. **Raising billions in funding** (optimistic timelines help)
2. **Competing for talent** (who wants to work on something 30 years away?)
3. **Building brands** (bold predictions get headlines)
4. **Genuinely excited** (when you work on cutting-edge tech, it's easy to
   extrapolate)
...
experts can't agree on what would _qualify_ as AGI, let alone when it'll arrive.
...
give you something that _sounds_ reasonable. Check the logic carefully, though.
It falls apart.
...
That's a _big_ problem for systems we're supposed to trust with important
decisions.
...
1. **Ask it to teach you things you think you know.** The gaps in your
   understanding are often invisible until someone (or something) explains it
   differently.

2. **Remember it might be completely making things up.** AI hallucinates
...
- Me: _Explains folder structure, liquid templating, shows examples_
- Student: "This CSS isn't working."
- Me: _Debugs, suggests fixes, explains why_
- Student: "Can you make this responsive?"
- Me: _Generates code, explains media queries_
...
- How do we deploy AI that makes everyone more productive, not just replaces
  jobs?
- How do we train people fast enough to adapt to the changes?
...
I _want_ to see AGI in my lifetime. It would be incredible. Transformative.
...
_Next week: What actually happens to jobs when AI gets better. Spoiler: It's way
more complicated than "robots take everything."_
