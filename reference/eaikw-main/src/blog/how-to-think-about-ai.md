...
title: "How to Think About AI Long-Term: A Framework That Actually Works"
date: 2025-11-09
description:
  "AGI by 2027? Self-driving cars everywhere? Don't trust predictions—trust
  principles. Here's a mental model for evaluating AI hype based on history, not
  hope."
tags: ["blog", "AI", "Framework", "Thinking", "Reality"]
---
...
technology is nearly impossible**—especially transformative technology like AI.
...
grunt work** and make programmers more productive.
...
- First use was printing indulgences (Catholic Church fundraising—not exactly
  enlightenment)
- Initially increased **mis**information (conspiracy theories, propaganda, fake
  news)
...
effects** (direct impacts). But the **second-order effects** (indirect
