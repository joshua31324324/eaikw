...
title: "How Education Needs to Change (And Why It Won't Happen Overnight)"
date: 2025-11-27
description:
  "I gave my class an impossible assignment: build custom Shopify themes in 7
  days. Every single student delivered. Here's what that means for education."
tags: ["blog", "AI", "Education", "Teaching", "Students"]
---
...
learn.** They still needed to understand:
...
- Students learned _when_ to use calculators and _how_ to verify results
...
- Teaching them to _evaluate_ AI outputs critically, not just accept them
...
**Intrinsic motivation still matters.** Getting students to _care_ about
...
students + AI**". The education part comes first.
...
_Next week: The productivity gains from AI—are they real? (Spoiler: Yes, but
smaller than you think.)_
